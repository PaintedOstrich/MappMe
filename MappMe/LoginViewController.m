...
-(void)loginButtonPress{
    NSArray* permissions = [[NSArray alloc] initWithObjects:@"friends_hometown",@"friends_location",@"friends_work_history",@"friends_education_history", @"publish_actions", @"user_photos", nil];
